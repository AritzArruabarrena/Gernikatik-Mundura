...
@Component({
  selector: 'app-marijesiak-hutsuneak-bete-1',
  templateUrl: './marijesiak-hutsuneak-bete-1.page.html',
  styleUrls: ['./marijesiak-hutsuneak-bete-1.page.scss'],
  standalone: false,
})
export class MarijesiakHutsuneakBete1Page implements OnInit {
...
playAudio() {
  ...
  if (this.audio) {
    ...
    this.audio = new Audio('../../assets/audio/musikabigarrengozatia.mp3');
  }
...
goToNextPage() {
  ...
  this.navCtrl.navigateForward('/tabs/marijesiak-hutsuneak-bete-2');
}
